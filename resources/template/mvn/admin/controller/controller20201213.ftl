...
public class ${modelClassSimpleName}Controller extends PaginationController {
    ...
    public String edit(@PathVariable @ModelAttribute("id") int id, @ModelAttribute("redirectUrl") String redirectUrl, Model model) {
    ...
    public String update(${modelClassSimpleName} ${modelClassSimpleName?uncap_first}, @PathVariable int id, String redirectUrl) {
    ...
    public String remove(@PathVariable int id, String redirectUrl) {
