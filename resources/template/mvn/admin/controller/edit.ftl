  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="box box-primary">
        ...
        <form id="edit-form" name="editForm" action="<${r"#"}if id??>/${viewDirName}/${r"$"}{id}/update<${r"#"}else>/${viewDirName}/create</${r"#"}if>" method="post" class="form-horizontal">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="${propertyNameMap["${propertyName}"]}" class="col-sm-1 control-label"><span class="required">*</span>${propertyName}:</label>
              <div class="col-sm-3">
